...
def plot_thWDM(m_hm,p_m_hm):
    ...
    ax.set_xscale("log")
    #ax.set_ylabel(r"$m_{\textrm{thWDM}} $ Normalized Posterior Distribution",fontsize=fontsize,pad=10)
    ...
    if paper_plot==True:
        ...
        fig.savefig(DARK_MATTER_PLOTS_LOCATION+"/strong_lensing_limits/m_thWDM_p_norm.jpg",bbox_inches = 'tight',pad_inches = 0.03,dpi=600)
