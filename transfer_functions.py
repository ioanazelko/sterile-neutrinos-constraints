...
def plot_sn_vs_wdm_overlay(t1, t2,paper_plot=False):
    ...
    plt.tight_layout()
    fig.savefig(DARK_MATTER_PLOTS_LOCATION+"/transfer_functions/m_sn_vs_m_thWDM.pdf",bbox_inches = 'tight',pad_inches = 0.03)
    fig.savefig(DARK_MATTER_PLOTS_LOCATION+"/transfer_functions/m_sn_vs_m_thWDM.jpg",bbox_inches = 'tight',pad_inches = 0.03,dpi=600)
    if paper_plot==True:
